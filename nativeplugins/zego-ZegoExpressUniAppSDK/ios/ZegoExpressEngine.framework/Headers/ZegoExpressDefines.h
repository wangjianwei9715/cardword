...
///
/// @param errorCode Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
/// @param command request command, see details https://doc-zh.zego.im/article/13610#1 for specific supported commands.
/// @param result request result, each request command has corresponding request result, see details https://doc-zh.zego.im/article/13610#1.
...
///
/// @param errorCode Error code, please refer to the error codes document https://doc-en.zego.im/en/5548.html for details.
/// @param resource The JSON string returned by the song ordering service, including song resource information, please refer to https://doc-zh.zego.im/article/13610 for details.
...
/// @param params request parameters, each request command has corresponding request parameters, see details https://doc-zh.zego.im/article/13610#1.
...
///
/// Available since: 2.13.0
/// Description: Support three ways to request accompaniment clip, pay-per-use, monthly billing by user, and monthly billing by room.
...
///
/// Available since: 2.15.0
/// Description: Start the scoring function.
...
///
/// Available since: 2.15.0
/// Description: Pause ongoing scoring.
...
///
/// Available since: 2.15.0
/// Description: End the current rating.
...
///
/// Available since: 2.15.0
/// Description: Reset the scores that have already been performed.
