<template>
  <view class="nice-cropper" :style="{height: height, width: width, background: backgroundColor}" @touchstart="touchstart" @touchmove.stop="touchmove" @touchcancel="touchend" @touchend="touchend">
    <image class="nice-cropper__image" :src="imagesrc" :style="{transform: transformMeta, width: image.width + 'px', height: image.height + 'px'}" />
...
<script lang="ts" src="./imageclip.ts">
</script>
