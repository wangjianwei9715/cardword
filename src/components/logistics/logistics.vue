	...
	<view class="page">
		...
		<view class="express">
			<view class="top ali-c">
				...
				<view class="text">
					<view class="text1">
						<view class="des">{{ wlInfo.post_name }} :{{ wlInfo.post_no }}
						</view>
						<view class="detail-copy" @click="onClickCopy(wlInfo.post_no)"></view>
					</view>
		...
		<!-- 收货地址 -->
		<view class="content bgf" v-if="wlInfo.list">
			<view>
				...
				<view class="flex list" v-for="item in wlInfo.list" :key="item.time">
					<view class="info flex1">
...
.content {
	margin: 20rpx;
	padding: 56rpx 46rpx 56rpx 56rpx;
	border-radius: 20rpx;
