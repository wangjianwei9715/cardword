import { ZegoScenario, ZegoPublishChannel, ZegoUser, ZegoRoomConfig, ZegoVideoConfig, ZegoPlayerConfig, ZegoMediaPlayer, ZegoEngineConfig, ZegoEngineProfile, ZegoVideoMirrorMode, ZegoOrientation, ZegoIMSendBroadcastMessageResult, ZegoIMSendBarrageMessageResult, ZegoIMSendCustomCommandResult, ZegoTrafficControlProperty, ZegoTrafficControlMinVideoBitrateMode, ZegoVideoStreamType, ZegoPublisherUpdateCdnUrlResult, ZegoCDNConfig, ZegoAECMode, ZegoANSMode, ZegoAudioRoute, ZegoMixerTask, ZegoMixerStartResult, ZegoMixerStopResult, ZegoEffectsBeautyParam, ZegoPlayerTakeSnapshotResult, ZegoPublisherConfig, ZegoRoomMode, ZegoAutoMixerTask, ZegoPublisherTakeSnapshotResult, ZegoWatermark, ZegoSoundLevelConfig, ZegoAudioConfig, ZegoRoomSetRoomExtraInfoResult } from "./ZegoExpressDefines";
...
export default class ZegoExpressEngine {
     ...
     */
    switchRoom(fromRoomID: string, toRoomID: string): Promise<void>;
    /**
     * Renew token.
     *
     ...
     */
    takePublishStreamSnapshot(): Promise<ZegoPublisherTakeSnapshotResult>;
    /**
