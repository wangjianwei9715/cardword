...
<template>
    <view class="content">
        ...
        <view class="ruleContainer" @click="pageJump('/pages/userinfo/level/rule')">
            <text>查看详细规则</text>
...
export default class ClassName extends BaseNode {
    ...
    levelInfo: any = {}
    userInfo: any = {}
    limitedOne: any = ['5条评论+3阅卡值', '10条评论+5阅卡值', '20条评论+10阅卡值', '50条评论+20阅卡值', '100条评论+50阅卡值']
    limiteTwo: any = ['10个赞+3阅卡值', '20个赞+5阅卡值', '50个赞+10阅卡值', '100个赞+20阅卡值', '200个赞+50阅卡值']
    onLoad(query: any) {
