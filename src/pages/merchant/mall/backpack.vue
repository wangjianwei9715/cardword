<template>
    <view class="content">
        <transitionNav @onClickRule="pageJump(`${mallRouter}/rule`)"
            :toolsMapCustomNew="custonRightIcon" ref='transitionNav' :needRightTools="['积分规则']"
            :needIconShadow="false" title="背包">
            <template slot="slotLeft">
                <view class="leftTitle">背包</view>
            </template>
        </transitionNav>
        ...
        <view class="myInfoContainer">
            ...
            <view class="myInfo_right" @click="pageJump(`${mallRouter}/useLog`)">
