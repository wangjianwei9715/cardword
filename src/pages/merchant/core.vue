<template>
    <view class='content'>
        ...
        <swiper indicator-dots autoplay circular :interval="3*1000" indicator-active-color="#333333" indicator-color="#CAC6C6" class="niceTimeContainer" v-if="niceTimeList&&niceTimeList.length">
