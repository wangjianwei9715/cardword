<template>
  <view class='content' style="width:750rpx; overflow-x: hidden">
    <view class="pageTopContainer">
      ...
      <view class="pageTop" ref="pageTop" id="pageTop"
        ...
        <view class="whiteBack flexCenter" @click="goBack">
          <image style="width:20rpx;height:36rpx" src="../../static/merchant/back.png" mode="scaleToFill" />
        </view>
        ...
        <view class="whiteBack flexCenter" @click="onClickShare">
          <image style="width:33rpx;height:33rpx" src="../../static/merchant/share.png" mode="scaleToFill" />
        </view>
    ...
    <view class="couponContainer uni-flex" v-if="!isMerchant && couponBrief && couponBrief.length">
      <view class="leftCoupon uni-flex">
        <view class="leftCoupon-item" style="margin-left: 14rpx;"
          v-for="(item, index) in couponBrief.length == 1 ? [...couponBrief, ...couponBrief] : couponBrief" :key="index"
          :style="{ marginLeft: index == 0 ? `14rpx` : `60rpx` }">
          <view class="price">
    ...
    <view class="niceTimeContainer" v-if='niceTimeFinish'>
      <swiper indicator-dots autoplay circular :interval="5 * 1000" indicator-active-color="#333333"
        indicator-color="#CAC6C6" style="width:100%;height:100%" v-if="niceTimeList && niceTimeList.length">
        <swiper-item class="niceTimeItem" v-for="(item, index) in niceTimeList" :key="index"
          style="display: flex;flex-wrap: nowrap;">
          <view v-for="(sItem, sNndex) in item" class="niceTimeImage" :style="{ marginRight: sNndex == 2 ? 0 : '24rpx' }"
            :key="'sImg' + sNndex">
