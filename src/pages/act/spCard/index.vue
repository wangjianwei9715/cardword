	...
	<view class="content">
		<view class="sp-top">
			...
			<view class="sp-tips-box">
				<view class="sp-tips-index" @click="showDrawer=true"><image class="sp-rule" src="../../../static/act/sp/rule.png" />规则</view>
				<navigator url="/pages/act/spCard/record_sp" hover-class="none" class="sp-tips-index">
					<image class="sp-mx" src="../../../static/act/sp/detail.png" />SP明细
				</navigator>
			</view>
