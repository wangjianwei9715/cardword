    ...
    <view class="content">
        <view class="descriptionContainer">
            ...
            <view class="des_content">
                活动时间：2023.08.17-2023.08.31。活动期间，玩家参与拼团，在卡密特效玩法中有概率获得特殊样式的特卡，为本活动的活动道具（跳过卡密特效仍可获得），卡密单价越高出现概率越大，集齐指定特卡卡组即可领取丰厚奖励。也可将特卡赠与他人。
                <br />
				<br />
				...
				1、活动共12种特卡卡组，每种卡组设置独立排名奖池，奖品可重复获得，越早集齐玩家获得的奖励更丰厚。
				<br />
