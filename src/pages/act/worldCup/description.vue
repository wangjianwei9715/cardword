<template>
    <view class="content">
        ...
        <view class="descriptionContainer" v-if="descriptionType == 1">
            ...
            <view class="des_content">
                倍数将根据实际客观情况产生调整，用户预测成功获得的世界豆取决于投注时的赔率，修改后的赔率只影响修改后参与投入的结果，不影响之前投注的倍数
            </view>
        </view>
        <view class="descriptionContainer" v-if="descriptionType == 2">
            <view>
                <view class="des_content">
                    活动期间参与【激情大抽奖】，每日早上九点开放晚上8:30
截止，每晚9点平台将公布中奖结果（公布时间存在延迟1-2
分钟，请耐心等待结果公布），开放期间，用户可以花费世界
豆解锁奖券每人每日可解锁6张，公布结果后会公示奖品的兑
换码，兑换码一致则为中奖
发货说明：实物商品平台将在1-30天内发货，收货地址为用户
的默认收货地址，未填写地址的用户在中奖后联系客服安排发
货
                </view>
            </view>
        </view>
