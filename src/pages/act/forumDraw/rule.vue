    ...
    <view class="content">
        ...
        <view class="descriptionContainer">
            ...
            <view class="des_content">
                即日起至9月8日 0:00，参与卡圈图鉴补充可获得卡币的同时可参与幸运抽奖，奖池内容不定期更新，请卡迷们留意
                <br />
                <br />
            </view>
            <view class="des_title">
            ...
            <view class="des_content">
                1.用户在补充完成图鉴的同时可获得对应卡币，补充图鉴完成每获得15卡币时即可获得1次免费抽奖机会（仅计算补充图鉴时获得的卡币）
                <br />
            </view>
            <view class="des_content">
                2.用户发布卡圈动态获得他人点赞，单条动态每获得15次赞累计1次抽奖次数（点赞取消重复点赞无效）
                <br />
                <br />
            </view>
