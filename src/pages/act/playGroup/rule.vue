...
<script lang="ts" scoped>
    ...
    export default class ClassName extends BaseNode {
        ...
        ruleList: any = [
            ...
            {
                title: '每日任务', desc: [`任务1：活动页面签到（每日可完成1次）
`, `任务2：点击“去分享”，将助力口令分享给好友，好友复制口令打开app并登录即可完成助力，每位用户每日可帮他人助力3次（每日可完成3次）
`, `任务3：赠送好友一次卡密即可完成（每日可完成1次）`, `任务4：当天消费累计每98元增加1次抽奖机会。 <strong style="color:#ff0730">购买拼团时限＜48小时的商品，将被计算为冻结消费金额（每日最多累计5000），冻结金额暂不统计任务进度，待商品拼成后解冻并计入任务，若商品未拼成将扣除冻结金额</strong>（每日可完成50次）
`]
            }
        ]
