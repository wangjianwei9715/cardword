...
<script lang="ts" scoped>
    ...
    export default class ClassName extends BaseNode {
        ...
        ruleList: any = [
            { title: '活动时间', desc: [`2020.8.31 15:00-2020.9.15 23:59`] },
            { title: '活动说明', desc: [`1.活动期间，玩家完成每日任务即可抽取球员，每日任务0点重置`, `2.凑齐指定球员组合可在活动页面兑换上组优惠券（全平台无门槛，有效期30天），每种组合均可重复兑换，次数不限。兑换成功后自动发放至我的-优惠券`,`3.通过不正当方式获取的奖励奖励将被扣除，包括但不限于刷单、刷小号等`] },
            {
