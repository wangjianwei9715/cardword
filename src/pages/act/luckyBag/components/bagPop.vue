 ...
 * @LastEditTime: 2023-11-16 15:00:57
            ...
            <scroll-view class="rewardScroll" :scroll-y="true">
                <view class="rewardContainer">
                    <view class="rewardItem" v-for="(item, index) in (goodsDetail.list || [])" :key="index">
                        <muqian-lazyLoad mode="aspectFit" style="display: flex;justify-content: center;" :src="$parsePic(item.pic)" borderRadius="3rpx" class="pic"></muqian-lazyLoad>
