...
export function formatNumber(number, keepNum = 0) {
    let result = '' + number;
    if (number >= 100000000) {
...
export function formatGold(number, symbol = ',', interval = 3) {
...
export function formatDateToMonth(time) {
...
export function formatFenToYuan(number) {
    let result = (number / 100) + '元';
    return result;
}
export function formatJiaoToYuan(number) {
...
export function getStrByDay(num) {
...
export function getStrDayNumber(num) {
    let time = new Date(num);
    let month = (time.getMonth() + 1) >= 10 ? (time.getMonth() + 1) : '0' + (time.getMonth() + 1);
    let date = time.getDate() >= 10 ? time.getDate() : '0' + time.getDate();
...
export function getStrByMinutes(num) {
    let time = new Date(num);
...
export function getGoodsImg(img) {
    if (img.indexOf(',') == -1) {
        return img;
    }
    else {
...
export function strToUint8Array(string) {
    let pos = 0;
...
;
export function swapArrayElement(arr, index1, index2) {
