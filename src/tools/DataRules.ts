 ...
 * @LastEditTime: 2024-05-28 11:23:57
 * Copyright: 2022 .
 * @Descripttion: 
 */
/**
...
export var goodsDetailHelp = [
    ...
    {content:'2.根据厂商官方公布的Checklist,组队方式分为随机球员、随机球队、随机位置等，每种方式对应一定的【拼团份数】，每一份对应一个随机卡密。商品中卡概率（获得任意卡片）为：购买份数/商品总份数'},
    ...
    {content:'6.中卡概率：f=每份卡密的中卡概率； P=【拼团份数】； Q=【拼团配置】中的卡片总张数； f=1-[(P-1)/P]^Q'}
]
/**
...
export var mallExchangeRule = [
    ...
    {content:'中国港澳台地区以及海外暂时无法发货，部分地区若受疫情影响则暂时无法发货。'}
]
/**
