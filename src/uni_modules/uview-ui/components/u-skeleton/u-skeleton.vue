...
<template>
	<view class="u-skeleton">
		<view class="u-skeleton__wrapper" ref="u-skeleton__wrapper" v-if="loading"
			style="display: flex; flex-direction: row;">
			<template v-if="!custom">
				<view class="u-skeleton__wrapper__avatar" v-if="avatar"
					:class="[`u-skeleton__wrapper__avatar--${avatarShape}`, animate && 'animate']" :style="{
				...
				<view class="u-skeleton__wrapper__content" ref="u-skeleton__wrapper__content" style="flex: 1;">
					<view class="u-skeleton__wrapper__content__title" v-if="title" :style="{
							width: uTitleWidth,
 ...
 * @property {Boolean}					custom	自定义骨架dom(默认 false)
