...
(function (app) {
    ...
    app.socketInfo = { tcp: '', tcpToken: '' };
    app.domaintest = 'http://192.168.0.38:8701/api/v1/';
    app.domain = 'http://121.196.201.181:8701/api/v1/';
    app.update_url = 'http://121.196.201.181:8081/api/';
    app.statusBarHeight = 0;
    app.platform = PlatformManager.getIns();
    app.payment = PayManager.getIns();
    app.http = HttpRequest.getIns();
    app.protobuf = null;
    app.data = {}; //登录数据
    ...
    app.version = '1.0.0';
    app.update = {}; //更新数据
    app.defaultAvatar = '/static/index/icon_photo.png';
    app.payload = ''; //unipush跳转参数
})(app || (app = {}));
