...
export var spCardRule = [
    {title:'',content:'活动时间5.26-6.26，参与5月26日15点后上架的21-22noir和21-22小真金系列有概率获得SP卡密，可用于兑换礼品。'},
    {title:'SP值获取：',content:'每条SP卡密基础为10点sp值，部分商品SP值会有增幅（详见商品说明）。若您的SP卡密中卡，可额外获SP值（随机卡种3倍；随机球员2倍），24小时内发放'},
