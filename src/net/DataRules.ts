...
export var spCardRule = [
    {content:'1、活动时间5.20-6.20，参与21-22noir和21-22小真金系列有概率获得SP卡密。noirSP卡密为鞋灯/聚光灯；小真金SP卡密为数据签（若商品为球员list，此球员存在鞋灯/聚光灯/数据签卡密则视为sp卡密）'},
    {content:'2、alllist每条sp卡密为1点sp值，球员list每条sp卡密为5点sp值，消耗sp值可兑换相应礼品'},
    {content:'3、赠送SP卡密将扣除相应的SP值，被赠送用户获得相应的SP值（若赠送时SP值已使用导致SP不够扣除，则收取用户获得仅获得被赠送者赠送时所扣除的SP值）'},
    {content:'4、实物类奖品请联系客服发放，优惠券类奖品自动发放'},
    {content:'5、活动结束后，未使用的SP值将失效，请在活动结束前使用'}
]